...
1. **Ensure** you have the latest version via [Lambda Layer or PyPi](../#install).
...
This also applies if you're using [**DynamoDB BatchProcessor**](https://docs.powertools.aws.dev/lambda/python/latest/utilities/batch/#processing-messages-from-dynamodb).
